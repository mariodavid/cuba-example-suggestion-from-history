...
public class CesfhTestContainer extends TestContainer {

    public CesfhTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/cesfh/app.properties",
    ...
    public static class Common extends CesfhTestContainer {

        public static final CesfhTestContainer.Common INSTANCE = new CesfhTestContainer.Common();
